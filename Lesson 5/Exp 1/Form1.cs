...
namespace InClass_152120211124_152120211106_Group3
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            string[] yemekler = { "Hamburger", "Sandviç", "Zurna Dürüm", "Balaban Kebap", "Kokoreç", "İskender", "Cantik" };
            foreach (string item in yemekler)
            {
                yemek.Items.Add(item); 
            }
        ...
        {
            if(isim.Text != "" && Tel.Text!= "" && yemek.SelectedItem.ToString() != "" && adet.Value.ToString() != "" && sehir.SelectedItem.ToString() != "" && ilce.SelectedItem.ToString() != "")
            {
                string text = DateTime.Now + " tarihli siparişiniz oluşturuldu: " + "," + isim.Text + "," + Tel.Text + "," + yemek.SelectedItem.ToString() + "," + adet.Value.ToString() + "," + sehir.SelectedItem.ToString() + "," + ilce.SelectedItem.ToString();
